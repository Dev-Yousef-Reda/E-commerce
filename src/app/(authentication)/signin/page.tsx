...
export default function page() {
  return (
    <main className=' mt-[100px] md:mt-[180px] w-[90%] md:w-[60%] lg:w-[50%] mx-auto bg-white rounded-xl px-7 py-5' >
      <h1 className='text-center text-lg md:text-4xl text-slate-700 font-bold' >Welcome Back!</h1>
      <Login />
      <div className='text-sm text-slate-500 mt-5 cursor-pointer flex justify-between '  >
