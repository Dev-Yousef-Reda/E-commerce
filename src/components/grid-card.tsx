...
import { GridPattern } from '_/components/ui/grid-pattern';
...
export function GridCard({
	...
	return (
		<div
			className={cn(
				'group/title bg-background relative isolate z-0 flex h-full flex-col justify-between overflow-hidden rounded-sm border px-5 py-4 transition-colors duration-75',
				className,
			)}
			{...props}
		>
			<div className="absolute inset-0">
				...
				<div
					className={cn(
						'absolute -inset-[10%] opacity-0 blur-[50px] transition-opacity duration-150 group-hover/title:opacity-10',
